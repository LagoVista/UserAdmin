...
//// ContentHash: 96dcbd856c95f137c4f9a222faf1bc5bad572fd48eac76501be902c2bc42bc48
//// IndexVersion: 2
//// --- END CODE INDEX META ---
...
//    {
//        private readonly IAppUserRelationalRepo _relationalRepo;
//        private readonly IOrganizationRelationalRepo _orgRelationalRepo;
//        private readonly IDeviceOwnerRelationalRepo _deviceOwnerRepo;
//        private readonly ISubscriptionRepo _subscriptionRepo;
//        private readonly IAdminLogger _adminLogger;
//        public RDBMSManager(IAppUserRelationalRepo relationalRepo, IDeviceOwnerRelationalRepo deviceOwnerRepo, IOrganizationRelationalRepo orgRelationalRepo, IRDBMSConnectionProvider connectionProvider, IAdminLogger adminLogger)
//        {
//            _relationalRepo = relationalRepo ?? throw new ArgumentNullException(nameof(relationalRepo));
//            _orgRelationalRepo = orgRelationalRepo ?? throw new ArgumentNullException(nameof(orgRelationalRepo));
...
//        {
//            _orgRelationalRepo.DeleteOrganizationAsync(id, )
//            var ctx = await GetBillingDataContextAsync(orgId);
