...
namespace LagoVista.UserAdmin.Models.Apps
{
    public class AppUserInboxManager : IAppUserInboxManager 
    {
        ...
        public AppUserInboxManager(IAppUserInboxRepo inboxRepo, ISystemNotificationsRepo systemNotificationRepo, IAppUserManager appUserManager)
        {
        ...
        public async Task<InvokeResult<int>> GetAllInboxItemCountAsync(EntityHeader org, EntityHeader user, ListRequest listRequest)
        {
        ...
        public async Task<ListResponse<InboxItem>> GetAllInboxItemsAsync(EntityHeader org, EntityHeader user, ListRequest listRequest)
        {
            ...
            var top = sysItems.FirstOrDefault();
            if (top != null)
                await this._appUserManager.MarkUserViewedSystemSerialIndex(top.Index, org, user);
