...
namespace LagoVista.UserAdmin.Interfaces.Managers.Passkeys
{
    ...
    {
        Task<InvokeResult<string>> BeginRegistrationOptionsAsync(string userId, EntityHeader org, EntityHeader user);
        ...
        Task<InvokeResult<string>> BeginAuthenticationOptionsAsync(string userId, bool isStepUp, EntityHeader org, EntityHeader user);
