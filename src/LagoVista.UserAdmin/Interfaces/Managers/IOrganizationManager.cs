...
namespace LagoVista.UserAdmin.Interfaces.Managers
{
    ...
    public interface IOrganizationManager : IOrgInformationSource
    {
        ...
        Task<InvokeResult> ValidateProvisionalOrganizationForPurgeAsync(string orgId, string appUserId, string subscriptionId);
        ...
        Task<bool> GetIsInvitationActiveAsync(string inviteId);
