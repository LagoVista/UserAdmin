...
namespace LagoVista.UserAdmin.ViewModels.Organization
{
    ...
    public class OrganizationViewModel
    {
        ...
        [FormField(LabelResource: Resources.UserAdminResources.Names.Common_Namespce, IsUserEditable: false, FieldType: FieldTypes.NameSpace, IsRequired: true, ResourceType: typeof(Resources.UserAdminResources))]
