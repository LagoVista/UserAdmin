...
namespace LagoVista.UserAdmin.Auth.Tests
{
    ...
    {
        private const string SuccessfulPasswordLoginBinding = "auth.test-binding.password.establish-session;auth.flow.password.establish-session;auth.transition.password-establish-session";

        [Test]
        [Property("AuthTestBinding", SuccessfulPasswordLoginBinding)]
