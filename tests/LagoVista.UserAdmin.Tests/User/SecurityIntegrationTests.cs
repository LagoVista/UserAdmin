...
// ContentHash: e9624b0e659106970d744b643dee7721e25eb8f3c41e921fba3706d600cf1b50
// IndexVersion: 2
// --- END CODE INDEX META ---
...
namespace LagoVista.UserAdmin.Tests.User
{
    ...
    public class SecurityIntegrationTests
    {
        ...
        public void Init()
        {
            ...
            _accessMangager = new UserAccessManager(securityManager.Object, _orgRepo, new ModuleRepo( new Mock<IDocumentCloudCachedServices>().Object), adminLogger);
        }
